...
public class DocumentService {
    ...
    public List<DocumentDto> getAllDocuments() {
        ...
        // Tối ưu: Lấy trực tiếp danh sách tài liệu hợp lệ của user từ Database
        // Thay vì kéo toàn bộ database lên RAM rồi mới filter
    ...
    public List<DocumentDto> getFilesByAccountId(Integer accountID) {
        ...
        return documents.stream().map(doc -> DocumentDto.builder()
                ...
                .docStatus(doc.getDocStatus())
                .docUploadedAt(doc.getDocUploadedAt())
                // Nếu cần map SubjectDto thì thêm vào đây
                .build()).collect(Collectors.toList());
    }
    ...
    public List<DocumentDto> getAllDocumentsForAdmin() {
        ...
        return documents.stream().map(doc -> {
            // Kiểm tra an toàn cho Subject đề phòng dữ liệu trống trong DB
            ...
            return DocumentDto.builder()
                    ...
                    .docStatus(doc.getDocStatus())
                    .docUploadedAt(doc.getDocUploadedAt())
                    .subject(subjectDto) // Truyền object đã check null vào đây
                    .build();
        }).collect(Collectors.toList());
    }
}
